    ...
    : QGLWidget(QGLFormat(QGL::SampleBuffers), parent)
{
    ...
    this->dummy = new QPointCloud();
    //this->dummy->data = copy_point_cloud(this->test->data);
    ...
    icp = new ICPThread(this->input, this->test, this->dummy, this->console, this);

    connect(icp, SIGNAL(error_minimized()), this, SLOT(repaint()), Qt::BlockingQueuedConnection);
    connect(icp, SIGNAL(dummy_transformed()), this, SLOT(repaint()), Qt::BlockingQueuedConnection);
